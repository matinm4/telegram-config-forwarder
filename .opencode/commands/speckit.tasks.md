...
> - فایل tasks.md را با عناوین و توضیحات فارسی بنویس.
> - شناسه وظایف (T001)، برچسب‌ها ([P], [US1]) و مسیر فایل‌ها انگلیسی باقی می‌مانند.
> - قالب tasks-template.md قبلا فارسی‌سازی شده — از همان عناوین فارسی استفاده کن.
