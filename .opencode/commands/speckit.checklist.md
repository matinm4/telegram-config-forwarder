...
> **تمام محتوای چک‌لیست تولیدشده توسط این دستور باید به زبان فارسی نوشته شود.**
> - عناوین دسته‌ها، موارد چک‌لیست و یادداشت‌ها را به فارسی بنویس.
> - شناسه موارد (CHK001) انگلیسی باقی می‌ماند.
